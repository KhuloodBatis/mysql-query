...
indicating whether this employee is also a manager, according to 
the data provided in the dept_manager table, 
...
SELECT
 ...
 e.last_name, CASE WHEN dm.emp_no IS NOT NULL THEN 'Manager' ELSE 'Employee' END AS is_manager
FROM
